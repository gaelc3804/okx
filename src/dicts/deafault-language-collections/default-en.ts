export const en = {
  login: {
    ...
    inputUserLabel: {
      phone: 'Phone',
      email: 'Email/Sub Account',
      qr: 'QR code'
    },
    inputPassLabel: {
      label: 'Password',
      forgotLable: 'Forgot your password?'
    },
    nextButton: {
      next: 'Next',
      login: 'Log In'
